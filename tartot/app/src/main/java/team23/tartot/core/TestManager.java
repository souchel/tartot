...
public class TestManager {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("a pas du tout de toute fa�on : "+paul.haveHigherTrump(3));
		...
		System.out.println("pas de mis�re mais mis�re annonc�e :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.MISERY), blu));
		System.out.println("double mis�re et mis�re annonc�e :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.MISERY), paul));
		System.out.println("simple mis�re et mis�re annonc�e :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.MISERY), gui));
		System.out.println("excuse mais mis�re annonc�e :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.MISERY), laure));
		...
		System.out.println("simple annonc�e mais non aquise :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.SIMPLE_HANDFUL), blu));
		blu.getHand().addCard(new Card(Suit.TRUMP, 16));
		System.out.println("simple annonc�e et aquise :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.SIMPLE_HANDFUL), blu));
		System.out.println("double annonc�e mais non aquise :"+gameManager.checkAnnouncesBegining(Arrays.asList(Announces.DOUBLE_HANDFUL), blu));
